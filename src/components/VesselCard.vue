<template>
    <v-card class="grey lighten-3">
      ...
      <v-layout row nowrap>
        <v-flex xs12>
        <v-list three-line>
          <v-subheader>Fartøystilstand<v-spacer></v-spacer><v-btn flat fab small @click="showStateDialog=true"><v-icon small>edit</v-icon></v-btn></v-subheader>
            <v-divider></v-divider>
            <v-list-tile avatar>
              <v-list-tile-avatar>
              ...
              <v-list-tile-content>
                <v-list-tile-title>{{vessel.state.description}}</v-list-tile-title>
          ...
          <v-list-tile avatar>
            <v-list-tile-avatar>
              <v-icon color="blue darken-1">info</v-icon>
            </v-list-tile-avatar>
            <v-list-tile-content>
              <v-list-tile-title>Merknader</v-list-tile-title>
              <v-list-tile-sub-title>Planlegger verkstedsopphold innen 3 uker. Antar å være ut av drift 3 dager. RS Skomvær III blir satt inn i denne perioden.</v-list-tile-sub-title>
            </v-list-tile-content>
          </v-list-tile>
